...
function HeroSection() {
  return (
    ...
    <h1
      ...
      <span className='relative whitespace-nowrap text-white-600 dark:text-gray-300'>by Joining</span>
      <br />
      {/* <span className="relative whitespace-nowrap text-white-600 dark:text-gray-300">Our Greatest Events</span> */}
      <span className="relative whitespace-nowrap text-orange-500 dark:text-orange-300">
        ...
        <span className="relative">Our Greatest Events</span>
      </span>
    </h1>
