           ...
           <div className="relative py-10 container mx-auto">
                   ...
                   <Slider {...reviewSettings}>
                    {TeamData?.map((team, idx) => (
                       <div key={idx} className="text-center bg-white w-[90%]">
                       <Image width={100} height={100} alt={`${team?.name}`} className="w-full h-[200px]" src={team?.img}/>
                       <div className="p-4">
                           <div className="text-md">
                               <a href="#"
                                   className="hover:text-indigo-500 text-gray-900 font-semibold transition duration-500 ease-in-out">{team?.name}</a>
                               <p className="text-gray-500 uppercase text-sm">{team?.position}</p>
                           </div>
                           <div className="my-4 flex justify-center items-center">
                               ...
                               <a href="#">
                                   <svg className="mr-3" width="16px" height="16px" version="1.1" id="Layer_1"
               ...
               C307.394,57.037,305.009,56.486,302.973,57.388z"></path>
                               ...
                               <a href="#">
                                   <svg width="19px" height="19px" version="1.1" id="Layer_1"
                                       xmlns="http://www.w3.org/2000/svg" x="0px"
                                       y="0px" viewBox="0 0 239.04 239.04">
                                       <g>
                                           <path d="M167.809,36.555c-22.276-0.183-44.597-1.054-66.919-0.504c-25.851,0.642-46.018,2.2-61.281,22.872
               ...
               c0.092-0.504,0.229-0.871,0.458-1.192C50.93,35.547,134.441,45.401,157.588,48.38z"></path>
                                           <path d="M176.059,72.627c0.092-10.955-13.567-14.438-20.901-7.7c-1.971,1.833-2.888,4.629-3.025,7.654
