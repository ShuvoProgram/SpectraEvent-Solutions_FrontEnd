            ...
            <ul className="">
                {
                    isError ? (
                        ...
                        faqData?.map((data: any) => (
                            <li className="text-left mb-10" key={data.id}>
                    <div className="flex flex-row items-start mb-5">
                        ...
                        <div className="bg-gray-100 p-5 px-10 w-full flex items-center">
                            <h4 className="text-md leading-6 font-medium text-gray-900">{data?.question}</h4>
                        </div>
                    </div>
                    ...
                    <div className="flex flex-row items-start">
                        ...
                        <div
                            className="hidden sm:flex items-center justify-center p-3 ml-3 rounded-full bg-orange-500 text-white border-4 border-white text-xl font-semibold">
...
{!isError && faqData?.length === 0 && !isLoading && (
  <Empty/>
)}
        </div>
